...
if ( isset($_SESSION['login']) ){ 
	...
	$id = $_POST['id'];
	$conta = $contas->getInformacoesConta($id);	
	$transacoes = $contas->getHistorico($id);
...
<div class="content p-1">
                <div class="list-group-item" style="background-color: #eaeef3">
                        ...
                        <div class="table-responsive">
							...
							<form method="POST" action="../controller/TransacaoController.php" style="font-weight: bold; font-style: italic;" class="formulario">
							...
							<div class="table-responsive">
								...
								<table class="table table-hover">
									...
									<tbody style="text-align: center;">
										...
										<tr>
											<td>
												<?= date("d/m/Y H:m:s", strtotime($transacao['data_operacao'])); ?>
											</td>	
